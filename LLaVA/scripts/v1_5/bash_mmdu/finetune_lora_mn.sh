...
export DATA_PATH=/mnt/petrelfs/liuziyu/V3Det/LLaVA/scripts/v1_5/finetune_json/finetune_data_mixed_llava_66k_mmdu_45k.json
...
export SAVE_PATH=/mnt/hwfile/mllm/liuziyu/finetune_LLaVa/llava-v1.5-7b-lora-llava66k-mmdu45k-16k
