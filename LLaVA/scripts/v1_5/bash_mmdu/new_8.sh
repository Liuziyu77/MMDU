...
export DATA_PATH=/mnt/petrelfs/liuziyu/V3Det/LLaVA/scripts/v1_5/finetune_json/finetune_data_mixed_llava_665k_mmdu_30k.json
...
export SAVE_PATH=/mnt/hwfile/mllm/liuziyu/finetune_LLaVa/lora-llava665k-mmdu30k-8k
