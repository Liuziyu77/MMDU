...
export DATA_PATH=/mnt/petrelfs/liuziyu/V3Det/LLaVA/scripts/v1_5/finetune_json/finetune_data_mixed_llava_333k_mmdu_22k.json
...
export SAVE_PATH=/mnt/hwfile/mllm/liuziyu/finetune_LLaVa/lora-llava333k-mmdu22k-16k
